# 🚀 Marmot: Kickstart Guide

Welcome to the **Marmot** project. All architectural blueprints, UX designs, and implementation steps have already been generated and are located in the `.plans/` directory.
...
---
*Marmot: The fast, lightweight, self-improving microkernel agent harness.*
